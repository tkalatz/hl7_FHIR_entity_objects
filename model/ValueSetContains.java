 ...
 *         &lt;element name="property" type="{http://hl7.org/fhir}ValueSet.Property1" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends BackboneElement
{
    ...
    protected List<ValueSetProperty1> property;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ValueSetProperty1 }
     * 
     * 
     */
    public List<ValueSetProperty1> getProperty() {
        if (property == null) {
            property = new ArrayList<ValueSetProperty1>();
        }

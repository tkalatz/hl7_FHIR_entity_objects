 ...
 * 
 * <p>Java class for SubscriptionTopic complex type.
 * 
 ...
 *         &lt;element name="resourceTrigger" type="{http://hl7.org/fhir}SubscriptionTopic.ResourceTrigger" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SubscriptionTopic", propOrder = {
    "url",
    "identifier",
    "version",
    "title",
    ...
    extends DomainResource
{
    ...
    protected List<SubscriptionTopicResourceTrigger> resourceTrigger;
    ...
    /**
     * Gets the value of the resourceTrigger property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the resourceTrigger property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getResourceTrigger().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubscriptionTopicResourceTrigger }
     * 
     * 
     */
    public List<SubscriptionTopicResourceTrigger> getResourceTrigger() {
        if (resourceTrigger == null) {
            resourceTrigger = new ArrayList<SubscriptionTopicResourceTrigger>();
        }

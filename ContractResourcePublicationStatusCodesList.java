...
/**
 * <p>Java class for ContractResourcePublicationStatusCodes-list.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ContractResourcePublicationStatusCodes-list">
 ...
 * 
 */
@XmlType(name = "ContractResourcePublicationStatusCodes-list")
@XmlEnum
public enum ContractResourcePublicationStatusCodesList {
    ...
    ContractResourcePublicationStatusCodesList(java.lang.String v) {
        value = v;
    }
    ...
    public static ContractResourcePublicationStatusCodesList fromValue(java.lang.String v) {
        for (ContractResourcePublicationStatusCodesList c: ContractResourcePublicationStatusCodesList.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
